...
const server = http.createServer(async(req,res)=>{
  ...
  if(pathname === '/health'){
    ...
    return res.end(JSON.stringify({ok:true,service:'pbot-web',stage2:true,build:'world01-story-20260915-3',viewport:'960x540',deployment:process.env.RAILWAY_DEPLOYMENT_ID || null}));
  }
